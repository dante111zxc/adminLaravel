        ...
        $data = $dataTable->eloquent($model)
            ...
            ->addColumn( 'action', function ($instance) {
                ...
                if (Gate::allows('page.edit')) {
                    $html .= '<a href="'.route('page.edit', $instance->id ).'" class="btn btn-xs btn-primary btnEdit" style="margin-right: 5px"><i class="fa fa-fw fa-edit"></i> Sửa</a>';
                }

                if (Gate::allows('page.delete')) {
                    $html .= '<a data-href="'.route('page.destroy', $instance->id ).'" data-toggle="modal" data-target="#modal-delete" class="btn btn-xs btn-danger btnDelete"><i class="fa fa-fw fa-trash-o"></i> Xóa</a>';
                }
