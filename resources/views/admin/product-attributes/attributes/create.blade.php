...
@section('content')
    <!-- Main content -->
    <form action="{{ route('attributes_store', $attribute_id )}}" method="POST">
        @csrf
                    ...
                    <div class="box-header">
                        @can('product-attributes.create')
                            <div class="pull-left">
                                ...
                                <a href="{{ route('attributes_create', $attribute_id) }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Thêm mới</a>
                            </div>
                        @endcan
                        <div class="pull-right">
                            @can('product-attributes.view')
                                <a href="{{ route('attributes_index', $attribute_id) }}" class="btn btn-sm btn-default"><i class="fa fa-close"></i> Hủy</a>
                            @endcan
