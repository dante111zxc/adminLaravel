...
@section('content')
    ...
    <!-- Main content -->
    <form action="{{ route('coupon-template.store') }}" method="POST">
        @csrf
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box-header">
                        <div class="pull-left">
                            <h3 class="box-title">Tạo loại giảm giá</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select style="width: 100%" name="type" id="type" class="form-control">
                                    <option value="1" selected="selected">Tỷ lệ (%)</option>
                                    <option value="2">Tiền mặt (VND)</option>
                                </select>
                            </div>
