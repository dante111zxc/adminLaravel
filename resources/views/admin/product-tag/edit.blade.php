...
@section('content')
    ...
    <!-- Main content -->
    <form action="{{route('product-tag.update',$taxonomy->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box-header">
                        <div class="pull-left">
                            <h3 class="box-title">Sửa thẻ tag</h3>
                            <a href="{{ route('product-tag.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Thêm mới</a>
                        </div>
                        <div class="pull-right">
                            <a href="{{ route('product-tag.index') }}" class="btn btn-sm btn-default"><i class="fa fa-close"></i> Hủy</a>
                            ...
                            <div class="form-group">
                                ...
                                <div class="box-thumbnail">
                                    <div class="box-preview">
                                        ...
                                        <img id="thumbnailPreview" src="{{ ($taxonomy->thumbnail) ? getThumbnail($taxonomy->thumbnail) : asset('adminLTE/dist/img/no-img.png')}}">
                                    </div>
