...
@section('content')
    ...
    <!-- Main content -->
    <form action="{{route('product-category.update', $taxonomy->id )}}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="form-group has-feedback @if ($errors->has('sort')) {{ 'has-error' }} @endif">
                                ...
                                <input type="text" name="sort" class="form-control" id="sort" value="{{ old('sort', ($taxonomy->sort) ? $taxonomy->sort : 9999) }}">
                                @if($errors->has('sort'))
                            ...
                            <div class="form-group has-feedback @if ($errors->has('feature')) {{ 'has-error' }} @endif">
                                ...
                                <select style="width: 100%" name="feature" id="feature" class="form-control">
                                    <option value="0"{{ ($taxonomy->feature == 0) ? 'selected' : '' }}>Ẩn</option>
                                    <option value="1"{{ ($taxonomy->feature == 1) ? 'selected' : '' }}>Hiện</option>
